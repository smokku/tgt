...
int tgt_set(struct tgt_object * obj,long tag,long value)
{
    switch(tag)
    {
	case TGTT_X: obj->x=(int) value; if(obj->ln.parent) tgt_refresh(obj->ln.parent); else tgt_refresh(obj); break;
	case TGTT_Y: obj->y=(int) value; if(obj->ln.parent) tgt_refresh(obj->ln.parent); else tgt_refresh(obj); break;
