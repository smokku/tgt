...
main()
{
	...
	(tagitem[]){TGTT_X, 28, TGTT_Y, 17,
		 ...
		 TGTT_CALLBACK,destroy, /*This will be called when the button is pressed*/
		 TGTT_END,0});
    ...
    fbo=tgt_createandlink(window,term,1002,(tagitem[]){TGTT_X, 2, TGTT_Y, 2,
		 ...
		 TGTT_YS,13,
		 TGTT_END,0});
    tgt_set(fbo,TGTT_FBPIXMAP_BUFFER,buffer);
