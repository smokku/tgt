...
int main()
{
    ...
    tgt_createandlink(window,myterm,TGT_CLASS_STRING,(long[]) {TGTT_X,2,TGTT_Y,3,TGTT_XS,30,TGTT_STRING_STRING,(long)"Type something here",TGTT_STRING_MAX,250,TGTT_END,0});
    ...
    tgt_createandlink(window,myterm,TGT_CLASS_SLIDER,(long[]) {TGTT_X,2,TGTT_Y,5,TGTT_XS,20,TGTT_SLIDER_CAPTION,(long)"Slide ",TGTT_SLIDER_MINVALUE,50,TGTT_SLIDER_MAXVALUE,140,TGTT_SLIDER_TYPE,TGT_SLIDERF_SHOWVALUE|TGT_SLIDERF_PERCENT,TGTT_CALLBACK,(long) slider_move,TGTT_END,0});
    progr=tgt_createandlink(window,myterm,TGT_CLASS_PROGRESS,(long[]) {TGTT_X,2,TGTT_Y,6,TGTT_XS,20,TGTT_PROGRESS_VALUE,10,TGTT_PROGRESS_ENDVALUE,50,TGTT_FG,6,TGTT_PROGRESS_TYPE,TGT_PROGRESSF_SHOWVALUE,TGTT_END,0});
