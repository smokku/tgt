...
int isblank (int c);
int g_error_handling=TGT_ERRORHANDLING_TGT;

void tgt_set_errorhandling(int t)
{
    g_error_handling=t;
}       	      
...
int tgt_save_conf(struct tgt_prefs * prefs,char *filename)
{
    ...
    fprintf(fh,"# Auto-generated by config.o/libtgt.so , Written 2000-2001 by Tomasz Sterna & Mateusz Golicz\n");
